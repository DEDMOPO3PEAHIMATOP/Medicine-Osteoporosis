...
df_1 = pd.read_csv(os.path.join(DATA_FILE, 'data_csv.csv'), sep=';', encoding='windows-1251')
print(df_1)
df_1.info()

# Смотрим на второй файл
df_2 = pd.read_csv(os.path.join(DATA_FILE, 'data2.csv'), sep=';', encoding='windows-1251')
print(df_2)
df_2.info()

# Смотрим на третий файл
df_3 = pd.read_csv(os.path.join(DATA_FILE, 'kniga_data.csv'), sep=';', encoding='windows-1251')
print(df_3)
df_3.info()
